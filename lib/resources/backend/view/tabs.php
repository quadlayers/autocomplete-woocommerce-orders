<ul class="subsubsub">
	...
	| <li><a target="_blank" href="<?php echo admin_url('admin.php?page=wc-settings_suggestions'); ?>"><?php echo esc_html__('Suggestions', 'autocomplete-woocommerce-orders'); ?></a></li>
